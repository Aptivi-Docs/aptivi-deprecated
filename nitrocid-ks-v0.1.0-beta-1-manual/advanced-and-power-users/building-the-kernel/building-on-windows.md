...
2.  In the repository location field, write `https://github.com/Aptivi/NitrocidKS.git`
    ...
    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-beta1/blob/main/.gitbook/assets/createrepo.png" alt=""><figcaption></figcaption></figure>
...
4.  Press `Solution Explorer` » `Switch Views`
    ...
    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-beta1/blob/main/.gitbook/assets/image%20(62).png" alt=""><figcaption></figcaption></figure>
5.  Press `Start` or press `Build` » `Build Solution`

    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-beta1/blob/main/.gitbook/assets/image%20(53).png" alt=""><figcaption></figcaption></figure>
6.  Navigate to the build output folder, `KSBuild`, and start `Nitrocid.exe`

    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-beta1/blob/main/.gitbook/assets/image%20(38).png" alt=""><figcaption></figcaption></figure>
