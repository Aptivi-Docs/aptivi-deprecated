...
Meanwhile, one of our libraries are severely outdated and should be updated to track the progress bar of upload and download progress. But we can't get the NuGet package manager for VB2010 because the download is failing although the Internet is working and can access sites fine.
...
For second-gen releases, go to \[\[Release Notes for Second Generation KS]].
