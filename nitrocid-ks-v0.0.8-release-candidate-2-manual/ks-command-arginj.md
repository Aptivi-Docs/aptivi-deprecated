...
* arginj quiet nohwprobe: Turn off kernel messages and hardware probing at the next reboot -BODY END-

-COLOR CONFIGURATION- arginj \[Arguments separated by spaces]=>Green arginj debug:=>Yellow arginj nohwprobe:=>Yellow arginj quiet nohwprobe:=>Yellow
