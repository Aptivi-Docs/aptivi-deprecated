...
2. Click on `Class Library (.NET Framework)`, select VB or C#, and name your custom splash. Select Framework as `.NET Framework 4.8`. When you're finished, click `Create`.
