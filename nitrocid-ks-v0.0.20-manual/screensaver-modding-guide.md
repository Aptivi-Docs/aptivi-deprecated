...
If you're going to make a screensaver, you can follow these steps:

1. Repeat steps 1-5 from the Modding guide, as well as steps 1-3 from the creation steps, but replace the Imports KS.ModParser with Imports KS.Screensaver
