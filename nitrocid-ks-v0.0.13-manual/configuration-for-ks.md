...
8. ColorMix - Activate True Color Mode: If true, uses true colors.
9. Disco - Activate True Color Mode: See above
10. GlitterColor - Activate True Color Mode: See above
11. Lines - Activate True Color Mode: See above
12. Dissolve - Activate True Color Mode: See above
13. Disco - Cycle Colors: Cycles the colors based on the color mode instead of random colors.
14. BouncingText - Text Shown: The text that is shown in BouncingText. If the text is longer than console width, it will be truncated by 15 characters.
