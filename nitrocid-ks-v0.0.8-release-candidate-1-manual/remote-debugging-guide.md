...
By default, it listens on port 3014, and can not be changed unless the source code modifications have been made. The debugging output will be the same as the output file, but missing all the messages before you connected. The first message you will get is `Debug device 192.168.1.104 joined`.
...
2. Instruct nc/netcat to connect to your debug machine to remotely debug (e.g. nc 192.168.1.104 3014)
