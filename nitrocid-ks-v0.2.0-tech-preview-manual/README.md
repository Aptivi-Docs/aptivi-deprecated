...
{% hint style="warning" %}
You are testing the technical preview of Nitrocid KS 0.2.0, which will be labelled as a beta version of the upcoming Nitrocid. It's normal for bugs to appear, but make sure to report them as soon as you spot them to help make the stable version more stable. Also, expect missing features.
{% endhint %}
