...
* sumfile (algorithm) (file)

## Examples

* sumfile MD5 DefenseShield.png: Calculates the MD5 sum of an image that has the defensive shield.
* sumfile SHA256 plasma-desktop\_5.16.5-0ubuntu1\_amd64.deb: Calculates the SHA256 sum of the Ubuntu/Debian package of KDE Plasma Desktop
