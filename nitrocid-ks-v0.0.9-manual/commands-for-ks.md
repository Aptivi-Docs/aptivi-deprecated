...
33. sumfile: Calculates the MD5, SHA1, or SHA256 sum of a specific file.
34. sumfiles: Calculates the MD5, SHA1, or SHA256 sums of the files in the specified directory.
35. sysinfo: You can show your system information, as well as the kernel settings.
36. usermanual: Opens https://github.com/EoflaOE/Kernel-Simulator/wiki
