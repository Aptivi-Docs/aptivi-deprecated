# Deleted APIs and Functions

During the lifecycle of Kernel Simulator, new versions tend to appear frequently. This causes some of the functions and APIs that we think are no longer relevant to be deleted. It doesn't list fields and screensaver codes, though.

## How to Read the List

It starts with the function name and where and which version range of KS it is found. It'll then tell you why it's deleted and if it's going to come back (likeliness). If said function or API has came back, it'll tell you which version, which function, and which file contains it. The format is as follows:
...
Here is the list of all the deleted APIs and functions:
...
### Class CPUFeatures\_Win

* Name: CPUFeatures\_Win
* Source file: CPUFeatures.vb
...
### ZipShell\_UpdateHelp()

* Name: ZipShell\_UpdateHelp()
* Source file: ZipHelpSystem.vb
* Version range: 0.0.16 - 0.0.18
* Reason for deletion: Avoiding duplicates
* Likeliness to come back: Highly unlikely

### TextEdit\_UpdateHelp()

* Name: TextEdit\_UpdateHelp()
