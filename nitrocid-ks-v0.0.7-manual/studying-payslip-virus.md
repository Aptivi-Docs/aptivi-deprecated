...
On May 17, 2019, there was a new virus compiled using VB.NET, called Payslip, that manages to obtain some of KS's features, like the flagging system, TextWriterColor, etc. Most of you have found viruses on shady sites, so you need to avoid these kinds of sites. We are here to study its disassembly of Payslip.
...
\[![Imgur](https://i.imgur.com/1MKQvGS.png)] \[![Imgur](https://i.imgur.com/hurODBE.png)] \[![Imgur](https://i.imgur.com/1L2645q.png)] \[![Imgur](https://i.imgur.com/mDvrnUi.png)]
