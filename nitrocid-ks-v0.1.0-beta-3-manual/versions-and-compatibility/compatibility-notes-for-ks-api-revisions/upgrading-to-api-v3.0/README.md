...
* Starting from API version `3.0.25.353`, Nitrocid KS **requires** elevated permission to run. This means that you may see the shield icon <img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-beta3/blob/main/.gitbook/assets/image.png" alt="" data-size="line"> in the corner of the Nitrocid logo. See why [here](from-0.1.0-beta-2-to-0.1.0-beta-3.md#specprobe-updated-to-1.2.0).
