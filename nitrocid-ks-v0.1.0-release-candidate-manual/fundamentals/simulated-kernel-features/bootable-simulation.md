...
2.  Unpack the downloaded file to one of the paths, depending on the platform. You may need to create the below folders:
    ...
    * Linux: `~/.config/grilo/Bootables/ks`
    ...
    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/.gitbook/assets/Beta3-063-GRILO.png" alt=""><figcaption></figcaption></figure>
3.  Start the GRILO bootloader (.NET 8.0), and choose one of the `Nitrocid` options\\

    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/.gitbook/assets/Beta3-064-GRILO.png" alt=""><figcaption></figcaption></figure>
