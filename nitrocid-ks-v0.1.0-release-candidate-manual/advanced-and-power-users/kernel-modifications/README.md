...
{% content-ref url="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/advanced-and-power-users/kernel-modifications/broken-reference/README.md" %}
[https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/advanced-and-power-users/kernel-modifications/broken-reference/README.md](https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/advanced-and-power-users/kernel-modifications/broken-reference/README.md)
{% endcontent-ref %}
