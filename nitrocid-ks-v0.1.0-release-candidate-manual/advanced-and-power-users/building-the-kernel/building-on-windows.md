...
2.  In the repository location field, write `https://github.com/Aptivi/NitrocidKS.git`
    ...
    <div align="left"><figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/.gitbook/assets/createrepo.png" alt=""><figcaption></figcaption></figure></div>
...
4. Press `Solution Explorer` » `Switch Views` and double click on `Nitrocid.sln`\
   ![](https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/.gitbook/assets/image%20\(46\).png)
5. Press `Start` or press `Build` » `Build Solution` to build\
   <img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/.gitbook/assets/image%20(48).png" alt="" data-size="original">
6.  Navigate to the build output folder, `KSBuild`, and double click on the `Nitrocid.exe` file\\

    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/.gitbook/assets/Beta3-065-Adv-Building.png" alt=""><figcaption></figcaption></figure>
...
5.  After building is done, run `dotnet run` on the `Nitrocid.csproj` file like so:\\
    ...
    <figure><img src="https://github.com/Aptivi-Stable-Docs/nks-manual-0.1.0-rc/blob/main/.gitbook/assets/Beta3-066-Adv-Building.png" alt=""><figcaption></figcaption></figure>
